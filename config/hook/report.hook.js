...
defineSupportCode(({ registerListener }) => {
  ...
  function adjustAndSaveJsonFile(capabilities, report) {
    ...
    if (jsonReport.length > 0) {
      ...
      const snapshotPath = join(projectRoot, 'reports/json-output');
      ...
      jsonReport[0].metadata = {
        browser: {
          ...
          version: '104' // Add your version or dynamically add your version here
        },
        device: "local development machine",
        platform: {
          name: 'Android',          // Add your platform name here
          version: '12'    // Add your platform version here
        }
      };
